...
接口: stock\_szse\_sector\_summary
...
接口: stock\_zh\_a\_spot\_em

目标地址: https://quote.eastmoney.com/center/gridlist.html#hs\_a\_board
...
接口: stock\_sh\_a\_spot\_em

目标地址: http://quote.eastmoney.com/center/gridlist.html#sh\_a\_board
...
接口: stock\_sz\_a\_spot\_em

目标地址: http://quote.eastmoney.com/center/gridlist.html#sz\_a\_board
...
接口: stock\_bj\_a\_spot\_em

目标地址: http://quote.eastmoney.com/center/gridlist.html#bj\_a\_board
...
接口: stock\_cy\_a\_spot\_em

目标地址: https://quote.eastmoney.com/center/gridlist.html#gem\_board
...
接口: stock\_kc\_a\_spot\_em

目标地址: http://quote.eastmoney.com/center/gridlist.html#kcb\_board
...
##### AB 股比价[](https://akshare.akfamily.xyz/data/stock/stock.html#ab "Link to this heading")

接口: stock\_zh\_ab\_comparison\_em

目标地址: https://quote.eastmoney.com/center/gridlist.html#ab\_comparison
...
接口: stock\_zh\_a\_spot

目标地址: https://vip.stock.finance.sina.com.cn/mkt/#hs\_a
...
接口: stock\_individual\_spot\_xq
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol='603777'; 股票代码可以在 **ak.stock\_zh\_a\_spot\_em()** 中获取|
|period|str|period='daily'; choice of {'daily', 'weekly', 'monthly'}|
|start\_date|str|start\_date='20210301'; 开始查询的日期|
|end\_date|str|end\_date='20210616'; 结束查询的日期|
...
接口: stock\_zh\_a\_daily

P.S. 建议切换为 stock\_zh\_a\_hist 接口使用(该接口数据质量高, 访问无限制)

目标地址: https://finance.sina.com.cn/realstock/company/sh600006/nc.shtml(示例)

描述: 新浪财经-沪深京 A 股的数据, 历史数据按日频率更新; 注意其中的 **sh689009** 为 CDR, 请 通过 **ak.stock\_zh\_a\_cdr\_daily** 接口获取
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol='sh600000'; 股票代码可以在 **ak.stock\_zh\_a\_spot()** 中获取|
|start\_date|str|start\_date='20201103'; 开始查询的日期|
|end\_date|str|end\_date='20201116'; 结束查询的日期|
...
|outstanding\_share|float64|流动股本; 注意单位: 股|
...
|start\_date|str|start\_date='19000101'; 开始查询的日期|
|end\_date|str|end\_date='20500101'; 结束查询的日期|
|adjust|str|默认返回不复权的数据; qfq: 返回前复权后的数据; hfq: 返回后复权后的数据|
|timeout|float|timeout=None; 默认不设置超时参数|
...
接口: stock\_zh\_a\_hist\_min\_em
...
|start\_date|str|start\_date="1979-09-01 09:32:00"; 日期时间; 默认返回所有数据|
|end\_date|str|end\_date="2222-01-01 09:32:00"; 日期时间; 默认返回所有数据|
...
接口: stock\_intraday\_sina

目标地址: https://vip.stock.finance.sina.com.cn/quotes\_service/view/cn\_bill.php?symbol=sz000001
...
接口: stock\_zh\_a\_hist\_pre\_min\_em
...
|---|---|---|
|symbol|str|symbol="000001"; 股票代码|
|start\_time|str|start\_time="09:00:00"; 时间; 默认返回所有数据|
|end\_time|str|end\_time="15:40:00"; 时间; 默认返回所有数据|
...
接口: stock\_zh\_a\_tick\_tx

目标地址: http://gu.qq.com/sz300494/gp/detail(示例)

描述: 每个交易日 16:00 提供当日数据; 如遇到数据缺失, 请使用 **ak.stock\_zh\_a\_tick\_163()** 接口(注意数据会有一定差异)
...
接口: stock\_zh\_a\_cdr\_daily

目标地址: https://finance.sina.com.cn/realstock/company/sh689009/nc.shtml

描述: 上海证券交易所-科创板-CDR

限量: 单次返回指定 CDR 的日频率数据, 分钟历史行情数据可以通过 stock\_zh\_a\_minute 获取
...
|start\_date|str|start\_date='20201103'|
|end\_date|str|end\_date='20201116'|
...
接口: stock\_zh\_b\_spot\_em

目标地址: http://quote.eastmoney.com/center/gridlist.html#hs\_b\_board
...
接口: stock\_zh\_b\_spot

目标地址: http://vip.stock.finance.sina.com.cn/mkt/#hs\_b
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol='sh900901'; 股票代码可以在 **ak.stock\_zh\_b\_spot()** 中获取|
|start\_date|str|start\_date='20201103'; 开始查询的日期|
|end\_date|str|end\_date='20201116'; 结束查询的日期|
|adjust|str|默认返回不复权的数据; qfq: 返回前复权后的数据; hfq: 返回后复权后的数据; hfq-factor: 返回后复权因子; qfq-factor: 返回前复权因子|
...
接口: stock\_zh\_a\_new

目标地址: http://vip.stock.finance.sina.com.cn/mkt/#new\_stock
...
接口: stock\_zh\_a\_st\_em

目标地址: https://quote.eastmoney.com/center/gridlist.html#st\_board
...
接口: stock\_zh\_a\_stop\_em

目标地址: http://quote.eastmoney.com/center/gridlist.html#staq\_net\_board
...
|after\_volume|float64|盘后量; 参见[科创板盘后固定价格交易](http://www.sse.com.cn/lawandrules/sserules/tib/trading/c/4729491.shtml)|
|after\_amount|float64|盘后额; 参见[科创板盘后固定价格交易](http://www.sse.com.cn/lawandrules/sserules/tib/trading/c/4729491.shtml)|
|outstanding\_share|float64|流通股本(股)|
...
|名称|类型|描述|
|---|---|---|
|from\_page|int|from\_page=1; 始获取的页码|
|to\_page|int|to\_page=100; 结束获取的页码|
...
接口: stock\_zh\_ah\_spot\_em

目标地址: https://quote.eastmoney.com/center/gridlist.html#ah\_comparison
...
接口: stock\_zh\_ah\_spot

目标地址: https://stockapp.finance.qq.com/mstats/#mod=list&id=hk\_ah&module=HK&type=AH
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="02318"; 港股股票代码, 可以通过 **ak.stock\_zh\_ah\_name()** 函数获取|
|start\_year|str|start\_year="2000"; 开始年份|
|end\_year|str|end\_year="2019"; 结束年份|
...
接口: stock\_us\_spot\_em

目标地址: https://quote.eastmoney.com/center/gridlist.html#us\_stocks
...
描述: 新浪财经-美股; 获取的数据有 15 分钟延迟; 建议使用 ak.stock\_us\_spot\_em() 来获取数据
...
数据示例(美股股票代码可通过 ak.get\_us\_stock\_name() 函数返回值)
...
|名称|类型|描述|
|---|---|---|
|symbol|str|美股代码, 可以通过 **ak.stock\_us\_spot\_em()** 函数返回所有的 pandas.DataFrame 里面的 `代码` 字段获取|
|period|str|period='daily'; choice of {'daily', 'weekly', 'monthly'}|
|start\_date|str|start\_date="20210101"|
|end\_date|str|end\_date="20210601"|
...
接口: stock\_individual\_basic\_info\_us\_xq
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="105.ATER"; 美股代码可以通过 **ak.stock\_us\_spot\_em()** 函数返回所有的 pandas.DataFrame 里面的 `代码` 字段获取|
|start\_date|str|start\_date="1979-09-01 09:32:00"; 日期时间; 默认返回所有数据|
|end\_date|str|end\_date="2222-01-01 09:32:00"; 日期时间; 默认返回所有数据|
...
|名称|类型|描述|
|---|---|---|
|symbol|str|美股代码, 可以通过 **ak.get\_us\_stock\_name()** 函数返回所有美股代码, 由于美股数据量大, 建议按需要获取|
|adjust|str|adjust="qfq" 则返回前复权后的数据，默认 adjust="", 则返回未复权的数据|

**ak.get\_us\_stock\_name()**: will return a pandas.DataFrame, which contains name, cname and symbol, you should use symbol!
...
|---|---|---|
|date|datetime64|日期|
|qfq\_factor|float|前复权因子|
|adjust|float|由于前复权会出现负值, 该值为调整因子|

P.S. 复权计算公式: 未复权数据 \* qfq\_factor + adjust
...
接口: stock\_us\_pink\_spot\_em

目标地址: http://quote.eastmoney.com/center/gridlist.html#us\_pinksheet
...
接口: stock\_us\_famous\_spot\_em

目标地址: http://quote.eastmoney.com/center/gridlist.html#us\_wellknown
...
接口: stock\_hk\_spot\_em

目标地址: http://quote.eastmoney.com/center/gridlist.html#hk\_stocks
...
接口: stock\_hk\_main\_board\_spot\_em

目标地址: https://quote.eastmoney.com/center/gridlist.html#hk\_mainboard
...
目标地址: https://vip.stock.finance.sina.com.cn/mkt/#qbgg\_hk
...
接口: stock\_individual\_basic\_info\_hk\_xq
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="01611"; 港股代码可以通过 **ak.stock\_hk\_spot\_em()** 函数返回所有的 pandas.DataFrame 里面的 `代码` 字段获取|
|period|str|period='5'; choice of {'1', '5', '15', '30', '60'}; 其中 1 分钟数据返回近 5 个交易日数据且不复权|
|adjust|str|adjust=''; choice of {'', 'qfq', 'hfq'}; '': 不复权, 'qfq': 前复权, 'hfq': 后复权, 其中 1 分钟数据返回近 5 个交易日数据且不复权|
|start\_date|str|start\_date="1979-09-01 09:32:00"; 日期时间; 默认返回所有数据|
|end\_date|str|end\_date="2222-01-01 09:32:00"; 日期时间; 默认返回所有数据|
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="00593"; 港股代码,可以通过 **ak.stock\_hk\_spot\_em()** 函数返回所有港股代码|
|period|str|period='daily'; choice of {'daily', 'weekly', 'monthly'}|
|start\_date|str|start\_date="19700101"; 开始日期|
|end\_date|str|end\_date="22220101"; 结束日期|
...
|名称|类型|描述|
|---|---|---|
|symbol|str|港股代码,可以通过 **ak.stock\_hk\_spot()** 函数返回所有港股代码|
...
接口: stock\_hk\_famous\_spot\_em

目标地址: https://quote.eastmoney.com/center/gridlist.html#hk\_wellknown
...
接口: stock\_hk\_security\_profile\_em

目标地址: https://emweb.securities.eastmoney.com/PC\_HKF10/pages/home/index.html?code=03900&type=web&color=w#/CompanyProfile
...
接口: stock\_hk\_company\_profile\_em
...
### 财务指标[](https://akshare.akfamily.xyz/data/stock/stock.html#id75 "Link to this heading")

接口: stock\_hk\_financial\_indicator\_em

目标地址: https://emweb.securities.eastmoney.com/PC\_HKF10/pages/home/index.html?code=03900&type=web&color=w#/CoreReading
...
### 分红派息[](https://akshare.akfamily.xyz/data/stock/stock.html#id76 "Link to this heading")

接口: stock\_hk\_dividend\_payout\_em
...
## 机构调研[](https://akshare.akfamily.xyz/data/stock/stock.html#id77 "Link to this heading")

### 机构调研-统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id78 "Link to this heading")

接口: stock\_jgdy\_tj\_em
...
### 机构调研-详细[](https://akshare.akfamily.xyz/data/stock/stock.html#id79 "Link to this heading")

接口: stock\_jgdy\_detail\_em
...
## 主营介绍-同花顺[](https://akshare.akfamily.xyz/data/stock/stock.html#id80 "Link to this heading")
...
## 主营构成-东财[](https://akshare.akfamily.xyz/data/stock/stock.html#id81 "Link to this heading")

接口: stock\_zygc\_em

目标地址: https://emweb.securities.eastmoney.com/PC\_HSF10/BusinessAnalysis/Index?type=web&code=SH688041#
...
## 股票质押[](https://akshare.akfamily.xyz/data/stock/stock.html#id82 "Link to this heading")

### 股权质押市场概况[](https://akshare.akfamily.xyz/data/stock/stock.html#id83 "Link to this heading")

接口: stock\_gpzy\_profile\_em
...
### 上市公司质押比例[](https://akshare.akfamily.xyz/data/stock/stock.html#id84 "Link to this heading")
...
### 重要股东股权质押明细[](https://akshare.akfamily.xyz/data/stock/stock.html#id85 "Link to this heading")
...
### 质押机构分布统计-证券公司[](https://akshare.akfamily.xyz/data/stock/stock.html#id86 "Link to this heading")

接口: stock\_gpzy\_distribute\_statistics\_company\_em
...
### 质押机构分布统计-银行[](https://akshare.akfamily.xyz/data/stock/stock.html#id87 "Link to this heading")

接口: stock\_gpzy\_distribute\_statistics\_bank\_em
...
### 上市公司质押比例[](https://akshare.akfamily.xyz/data/stock/stock.html#id88 "Link to this heading")

接口: stock\_gpzy\_industry\_data\_em
...
## 商誉专题[](https://akshare.akfamily.xyz/data/stock/stock.html#id89 "Link to this heading")

### A股商誉市场概况[](https://akshare.akfamily.xyz/data/stock/stock.html#id90 "Link to this heading")

接口: stock\_sy\_profile\_em
...
### 商誉减值预期明细[](https://akshare.akfamily.xyz/data/stock/stock.html#id91 "Link to this heading")

接口: stock\_sy\_yq\_em
...
### 个股商誉减值明细[](https://akshare.akfamily.xyz/data/stock/stock.html#id92 "Link to this heading")

接口: stock\_sy\_jz\_em
...
### 个股商誉明细[](https://akshare.akfamily.xyz/data/stock/stock.html#id93 "Link to this heading")
...
### 行业商誉[](https://akshare.akfamily.xyz/data/stock/stock.html#id94 "Link to this heading")

接口: stock\_sy\_hy\_em
...
## 股票账户统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id95 "Link to this heading")

### 股票账户统计月度[](https://akshare.akfamily.xyz/data/stock/stock.html#id96 "Link to this heading")

接口: stock\_account\_statistics\_em
...
## 分析师指数[](https://akshare.akfamily.xyz/data/stock/stock.html#id97 "Link to this heading")

### 分析师指数排行[](https://akshare.akfamily.xyz/data/stock/stock.html#id98 "Link to this heading")

接口: stock\_analyst\_rank\_em
...
### 分析师详情[](https://akshare.akfamily.xyz/data/stock/stock.html#id99 "Link to this heading")

接口: stock\_analyst\_detail\_em
...
|名称|类型|描述|
|---|---|---|
|analyst\_id|str|analyst\_id="11000257131"; 分析师ID, 从 ak.stock\_analyst\_rank\_em() 获取|
...
## 千股千评[](https://akshare.akfamily.xyz/data/stock/stock.html#id100 "Link to this heading")

接口: stock\_comment\_em
...
## 千股千评详情[](https://akshare.akfamily.xyz/data/stock/stock.html#id101 "Link to this heading")

### 主力控盘[](https://akshare.akfamily.xyz/data/stock/stock.html#id102 "Link to this heading")

#### 机构参与度[](https://akshare.akfamily.xyz/data/stock/stock.html#id103 "Link to this heading")

接口: stock\_comment\_detail\_zlkp\_jgcyd\_em
...
### 综合评价[](https://akshare.akfamily.xyz/data/stock/stock.html#id104 "Link to this heading")

#### 历史评分[](https://akshare.akfamily.xyz/data/stock/stock.html#id105 "Link to this heading")

接口: stock\_comment\_detail\_zhpj\_lspf\_em
...
### 市场热度[](https://akshare.akfamily.xyz/data/stock/stock.html#id106 "Link to this heading")

#### 用户关注指数[](https://akshare.akfamily.xyz/data/stock/stock.html#id107 "Link to this heading")

接口: stock\_comment\_detail\_scrd\_focus\_em
...
#### 市场参与意愿[](https://akshare.akfamily.xyz/data/stock/stock.html#id108 "Link to this heading")

接口: stock\_comment\_detail\_scrd\_desire\_em
...
#### 日度市场参与意愿[](https://akshare.akfamily.xyz/data/stock/stock.html#id109 "Link to this heading")

接口: stock\_comment\_detail\_scrd\_desire\_daily\_em
...
## 沪深港通资金流向[](https://akshare.akfamily.xyz/data/stock/stock.html#id110 "Link to this heading")

接口: stock\_hsgt\_fund\_flow\_summary\_em
...
## 沪深港通持股[](https://akshare.akfamily.xyz/data/stock/stock.html#id111 "Link to this heading")

### 结算汇率-深港通[](https://akshare.akfamily.xyz/data/stock/stock.html#id112 "Link to this heading")

接口: stock\_sgt\_settlement\_exchange\_rate\_szse
...
### 结算汇率-沪港通[](https://akshare.akfamily.xyz/data/stock/stock.html#id113 "Link to this heading")

接口: stock\_sgt\_settlement\_exchange\_rate\_sse
...
### 参考汇率-深港通[](https://akshare.akfamily.xyz/data/stock/stock.html#id114 "Link to this heading")

接口: stock\_sgt\_reference\_exchange\_rate\_szse
...
### 参考汇率-沪港通[](https://akshare.akfamily.xyz/data/stock/stock.html#id115 "Link to this heading")

接口: stock\_sgt\_reference\_exchange\_rate\_sse
...
### 港股通成份股[](https://akshare.akfamily.xyz/data/stock/stock.html#id116 "Link to this heading")

接口: stock\_hk\_ggt\_components\_em

目标地址: https://quote.eastmoney.com/center/gridlist.html#hk\_components
...
### 沪深港通分时数据[](https://akshare.akfamily.xyz/data/stock/stock.html#id117 "Link to this heading")

接口: stock\_hsgt\_fund\_min\_em
...
### 板块排行[](https://akshare.akfamily.xyz/data/stock/stock.html#id118 "Link to this heading")

接口: stock\_hsgt\_board\_rank\_em
...
### 个股排行[](https://akshare.akfamily.xyz/data/stock/stock.html#id119 "Link to this heading")

接口: stock\_hsgt\_hold\_stock\_em
...
### 每日个股统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id120 "Link to this heading")

接口: stock\_hsgt\_stock\_statistics\_em

目标地址: http://data.eastmoney.com/hsgtcg/StockStatistics.aspx

描述: 东方财富网-数据中心-沪深港通-沪深港通持股-每日个股统计

限量: 单次获取指定 market 的 start\_date 和 end\_date 之间的所有数据, 该接口只能获取近期的数据
...
|start\_date|str|start\_date="20210601"; 此处指定近期交易日|
|end\_date|str|end\_date="20210608"; 此处指定近期交易日|
...
### 机构排行[](https://akshare.akfamily.xyz/data/stock/stock.html#id121 "Link to this heading")

接口: stock\_hsgt\_institution\_statistics\_em
...
|start\_date|str|start\_date="20201218"; 此处指定近期交易日|
|end\_date|str|end\_date="20201218"; 此处指定近期交易日|
...
### 沪深港通-港股通(沪>港)实时行情[](https://akshare.akfamily.xyz/data/stock/stock.html#id122 "Link to this heading")

接口: stock\_hsgt\_sh\_hk\_spot\_em

目标地址: https://quote.eastmoney.com/center/gridlist.html#hk\_sh\_stocks
...
### 沪深港通历史数据[](https://akshare.akfamily.xyz/data/stock/stock.html#id123 "Link to this heading")

接口: stock\_hsgt\_hist\_em
...
### 沪深港通持股-个股[](https://akshare.akfamily.xyz/data/stock/stock.html#id124 "Link to this heading")

接口: stock\_hsgt\_individual\_em
...
### 沪深港通持股-个股详情[](https://akshare.akfamily.xyz/data/stock/stock.html#id125 "Link to this heading")

接口: stock\_hsgt\_individual\_detail\_em

目标地址: http://data.eastmoney.com/hsgtcg/StockHdStatistics/002008.html(示例)

描述: 东方财富网-数据中心-沪深港通-沪深港通持股-具体股票-个股详情

限量: 单次获取指定 symbol 的在 start\_date 和 end\_date 之间的所有数据; 注意只能返回 90 个交易日内的数据
...
|start\_date|str|start\_date="20210830"; 注意只能返回离最近交易日 90 个交易日内的数据|
|end\_date|str|end\_date="20211026"; 注意只能返回离最近交易日 90 个交易日内的数据|
...
## 停复牌信息[](https://akshare.akfamily.xyz/data/stock/stock.html#id126 "Link to this heading")
...
## 停复牌[](https://akshare.akfamily.xyz/data/stock/stock.html#id127 "Link to this heading")

接口: news\_trade\_notify\_suspend\_baidu
...
## 分红派息[](https://akshare.akfamily.xyz/data/stock/stock.html#id128 "Link to this heading")

接口: news\_trade\_notify\_dividend\_baidu
...
## 个股新闻[](https://akshare.akfamily.xyz/data/stock/stock.html#id129 "Link to this heading")
...
## 财经内容精选[](https://akshare.akfamily.xyz/data/stock/stock.html#id130 "Link to this heading")
...
## 财报发行[](https://akshare.akfamily.xyz/data/stock/stock.html#id131 "Link to this heading")

接口: news\_report\_time\_baidu
...
## 新股数据[](https://akshare.akfamily.xyz/data/stock/stock.html#id132 "Link to this heading")

### 打新收益率[](https://akshare.akfamily.xyz/data/stock/stock.html#id133 "Link to this heading")
...
### 新股申购与中签[](https://akshare.akfamily.xyz/data/stock/stock.html#id134 "Link to this heading")

接口: stock\_xgsglb\_em

目标地址: https://data.eastmoney.com/xg/xg/default\_2.html
...
## 年报季报[](https://akshare.akfamily.xyz/data/stock/stock.html#id135 "Link to this heading")

### 业绩报表[](https://akshare.akfamily.xyz/data/stock/stock.html#id136 "Link to this heading")
...
### 业绩快报[](https://akshare.akfamily.xyz/data/stock/stock.html#id137 "Link to this heading")
...
### 业绩预告[](https://akshare.akfamily.xyz/data/stock/stock.html#id138 "Link to this heading")
...
### 预约披露时间-东方财富[](https://akshare.akfamily.xyz/data/stock/stock.html#id139 "Link to this heading")
...
### 预约披露时间-巨潮资讯[](https://akshare.akfamily.xyz/data/stock/stock.html#id140 "Link to this heading")

接口: stock\_report\_disclosure
...
### 信息披露公告-巨潮资讯[](https://akshare.akfamily.xyz/data/stock/stock.html#id141 "Link to this heading")

接口: stock\_zh\_a\_disclosure\_report\_cninfo
...
|start\_date|str|start\_date="20230618"|
|end\_date|str|end\_date="20231219"|
...
### 信息披露调研-巨潮资讯[](https://akshare.akfamily.xyz/data/stock/stock.html#id142 "Link to this heading")

接口: stock\_zh\_a\_disclosure\_relation\_cninfo
...
### 行业分类数据-巨潮资讯[](https://akshare.akfamily.xyz/data/stock/stock.html#id143 "Link to this heading")

接口: stock\_industry\_category\_cninfo
...
### 上市公司行业归属的变动情况-巨潮资讯[](https://akshare.akfamily.xyz/data/stock/stock.html#id144 "Link to this heading")

接口: stock\_industry\_change\_cninfo

目标地址: http://webapi.cninfo.com.cn/#/apiDoc

描述: 巨潮资讯-数据-上市公司行业归属的变动情况

限量: 单次获取指定 symbol 在 start\_date 和 end\_date 之间的上市公司行业归属的变动情况数据
...
|start\_date|str|start\_date="20091227"|
|end\_date|str|end\_date="20220708"|
...
### 公司股本变动-巨潮资讯[](https://akshare.akfamily.xyz/data/stock/stock.html#id145 "Link to this heading")

接口: stock\_share\_change\_cninfo

目标地址: https://webapi.cninfo.com.cn/#/apiDoc

描述: 巨潮资讯-数据-公司股本变动

限量: 单次获取指定 symbol 在 start\_date 和 end\_date 之间的公司股本变动数据
...
|symbol|str|symbol="002594"|
|start\_date|str|start\_date="20091227"|
|end\_date|str|end\_date="20241021"|
...
### 配股实施方案-巨潮资讯[](https://akshare.akfamily.xyz/data/stock/stock.html#id146 "Link to this heading")

接口: stock\_allotment\_cninfo
...
|start\_date|str|start\_date="19700101"|
|end\_date|str|end\_date="22220222"|
...
### 公司概况-巨潮资讯[](https://akshare.akfamily.xyz/data/stock/stock.html#id147 "Link to this heading")

接口: stock\_profile\_cninfo
...
### 上市相关-巨潮资讯[](https://akshare.akfamily.xyz/data/stock/stock.html#id148 "Link to this heading")

接口: stock\_ipo\_summary\_cninfo
...
### 资产负债表-沪深[](https://akshare.akfamily.xyz/data/stock/stock.html#id149 "Link to this heading")
...
### 资产负债表-北交所[](https://akshare.akfamily.xyz/data/stock/stock.html#id150 "Link to this heading")

接口: stock\_zcfz\_bj\_em
...
### 利润表[](https://akshare.akfamily.xyz/data/stock/stock.html#id151 "Link to this heading")
...
### 现金流量表[](https://akshare.akfamily.xyz/data/stock/stock.html#id152 "Link to this heading")
...
## 高管持股[](https://akshare.akfamily.xyz/data/stock/stock.html#id153 "Link to this heading")

### 股东增减持[](https://akshare.akfamily.xyz/data/stock/stock.html#id154 "Link to this heading")
...
## 分红配送[](https://akshare.akfamily.xyz/data/stock/stock.html#id155 "Link to this heading")

### 分红配送-东财[](https://akshare.akfamily.xyz/data/stock/stock.html#id156 "Link to this heading")
...
### 分红配送详情-东财[](https://akshare.akfamily.xyz/data/stock/stock.html#id157 "Link to this heading")

接口: stock\_fhps\_detail\_em
...
### 分红情况-同花顺[](https://akshare.akfamily.xyz/data/stock/stock.html#id158 "Link to this heading")

接口: stock\_fhps\_detail\_ths
...
### 分红配送详情-港股-同花顺[](https://akshare.akfamily.xyz/data/stock/stock.html#id159 "Link to this heading")

接口: stock\_hk\_fhpx\_detail\_ths
...
## 资金流向[](https://akshare.akfamily.xyz/data/stock/stock.html#id160 "Link to this heading")

### 同花顺[](https://akshare.akfamily.xyz/data/stock/stock.html#id161 "Link to this heading")

#### 个股资金流[](https://akshare.akfamily.xyz/data/stock/stock.html#id162 "Link to this heading")

接口: stock\_fund\_flow\_individual

目标地址: https://data.10jqka.com.cn/funds/ggzjl/#refCountId=data\_55f13c2c\_254
...
#### 概念资金流[](https://akshare.akfamily.xyz/data/stock/stock.html#id163 "Link to this heading")

接口: stock\_fund\_flow\_concept

目标地址: https://data.10jqka.com.cn/funds/gnzjl/#refCountId=data\_55f13c2c\_254
...
#### 行业资金流[](https://akshare.akfamily.xyz/data/stock/stock.html#id164 "Link to this heading")

接口: stock\_fund\_flow\_industry

目标地址: http://data.10jqka.com.cn/funds/hyzjl/#refCountId=data\_55f13c2c\_254
...
#### 大单追踪[](https://akshare.akfamily.xyz/data/stock/stock.html#id165 "Link to this heading")

接口: stock\_fund\_flow\_big\_deal
...
### 东方财富[](https://akshare.akfamily.xyz/data/stock/stock.html#id166 "Link to this heading")

#### 个股资金流[](https://akshare.akfamily.xyz/data/stock/stock.html#id167 "Link to this heading")

接口: stock\_individual\_fund\_flow
...
#### 个股资金流排名[](https://akshare.akfamily.xyz/data/stock/stock.html#id168 "Link to this heading")

接口: stock\_individual\_fund\_flow\_rank
...
#### 大盘资金流[](https://akshare.akfamily.xyz/data/stock/stock.html#id169 "Link to this heading")

接口: stock\_market\_fund\_flow
...
#### 板块资金流排名[](https://akshare.akfamily.xyz/data/stock/stock.html#id170 "Link to this heading")

接口: stock\_sector\_fund\_flow\_rank
...
|sector\_type|str|sector\_type="行业资金流"; choice of {"行业资金流", "概念资金流", "地域资金流"}|
...
#### 主力净流入排名[](https://akshare.akfamily.xyz/data/stock/stock.html#id171 "Link to this heading")

接口: stock\_main\_fund\_flow
...
#### 行业个股资金流[](https://akshare.akfamily.xyz/data/stock/stock.html#id172 "Link to this heading")

接口: stock\_sector\_fund\_flow\_summary
...
#### 行业历史资金流[](https://akshare.akfamily.xyz/data/stock/stock.html#id173 "Link to this heading")

接口: stock\_sector\_fund\_flow\_hist
...
#### 概念历史资金流[](https://akshare.akfamily.xyz/data/stock/stock.html#id174 "Link to this heading")

接口: stock\_concept\_fund\_flow\_hist
...
## 筹码分布[](https://akshare.akfamily.xyz/data/stock/stock.html#id175 "Link to this heading")
...
## 基本面数据[](https://akshare.akfamily.xyz/data/stock/stock.html#id176 "Link to this heading")

### 股东大会[](https://akshare.akfamily.xyz/data/stock/stock.html#id177 "Link to this heading")
...
### 重大合同[](https://akshare.akfamily.xyz/data/stock/stock.html#id178 "Link to this heading")

接口: stock\_zdhtmx\_em

目标地址: https://data.eastmoney.com/zdht/mx.html

描述: 东方财富网-数据中心-重大合同-重大合同明细

限量: 单次返回指定 start\_date 和 end\_date 的所有数据

输入参数

|名称|类型|描述|
|---|---|---|
|start\_date|str|start\_date="20200819"|
|end\_date|str|end\_date="20230819"|
...
### 个股研报[](https://akshare.akfamily.xyz/data/stock/stock.html#id179 "Link to this heading")

接口: stock\_research\_report\_em
...
### 沪深京 A 股公告[](https://akshare.akfamily.xyz/data/stock/stock.html#id180 "Link to this heading")

接口: stock\_notice\_report
...
### 财务报表-新浪[](https://akshare.akfamily.xyz/data/stock/stock.html#id181 "Link to this heading")

接口: stock\_financial\_report\_sina

目标地址: https://vip.stock.finance.sina.com.cn/corp/go.php/vFD\_FinanceSummary/stockid/600600/displaytype/4.phtml?source=fzb&qq-pf-to=pcqq.group
...
### 财务报表-东财[](https://akshare.akfamily.xyz/data/stock/stock.html#id182 "Link to this heading")

#### 资产负债表-按报告期[](https://akshare.akfamily.xyz/data/stock/stock.html#id183 "Link to this heading")

接口: stock\_balance\_sheet\_by\_report\_em

目标地址: https://emweb.securities.eastmoney.com/PC\_HSF10/NewFinanceAnalysis/Index?type=web&code=sh600519#lrb-0
...
#### 资产负债表-按年度[](https://akshare.akfamily.xyz/data/stock/stock.html#id184 "Link to this heading")

接口: stock\_balance\_sheet\_by\_yearly\_em
...
#### 利润表-按报告期[](https://akshare.akfamily.xyz/data/stock/stock.html#id185 "Link to this heading")

接口: stock\_profit\_sheet\_by\_report\_em
...
#### 利润表-按年度[](https://akshare.akfamily.xyz/data/stock/stock.html#id186 "Link to this heading")

接口: stock\_profit\_sheet\_by\_yearly\_em
...
#### 利润表-按单季度[](https://akshare.akfamily.xyz/data/stock/stock.html#id187 "Link to this heading")

接口: stock\_profit\_sheet\_by\_quarterly\_em
...
#### 现金流量表-按报告期[](https://akshare.akfamily.xyz/data/stock/stock.html#id188 "Link to this heading")

接口: stock\_cash\_flow\_sheet\_by\_report\_em
...
#### 现金流量表-按年度[](https://akshare.akfamily.xyz/data/stock/stock.html#id189 "Link to this heading")

接口: stock\_cash\_flow\_sheet\_by\_yearly\_em
...
#### 现金流量表-按单季度[](https://akshare.akfamily.xyz/data/stock/stock.html#id190 "Link to this heading")

接口: stock\_cash\_flow\_sheet\_by\_quarterly\_em
...
### 财务报表-同花顺[](https://akshare.akfamily.xyz/data/stock/stock.html#id191 "Link to this heading")

#### 资产负债表[](https://akshare.akfamily.xyz/data/stock/stock.html#id192 "Link to this heading")

接口: stock\_financial\_debt\_ths
...
#### 利润表[](https://akshare.akfamily.xyz/data/stock/stock.html#id193 "Link to this heading")

接口: stock\_financial\_benefit\_ths
...
#### 现金流量表[](https://akshare.akfamily.xyz/data/stock/stock.html#id194 "Link to this heading")

接口: stock\_financial\_cash\_ths
...
### 财务报表-东财-已退市股票[](https://akshare.akfamily.xyz/data/stock/stock.html#id195 "Link to this heading")

#### 资产负债表-按报告期[](https://akshare.akfamily.xyz/data/stock/stock.html#id196 "Link to this heading")

接口: stock\_balance\_sheet\_by\_report\_delisted\_em

目标地址: https://emweb.securities.eastmoney.com/pc\_hsf10/pages/index.html?type=web&code=SZ000013#/cwfx/zcfzb
...
#### 利润表-按报告期[](https://akshare.akfamily.xyz/data/stock/stock.html#id197 "Link to this heading")

接口: stock\_profit\_sheet\_by\_report\_delisted\_em

目标地址: https://emweb.securities.eastmoney.com/pc\_hsf10/pages/index.html?type=web&code=SZ000013#/cwfx/lrb
...
#### 现金流量表-按报告期[](https://akshare.akfamily.xyz/data/stock/stock.html#id198 "Link to this heading")

接口: stock\_cash\_flow\_sheet\_by\_report\_delisted\_em

目标地址: https://emweb.securities.eastmoney.com/pc\_hsf10/pages/index.html?type=web&code=SZ000013#/cwfx/xjllb
...
### 港股财务报表[](https://akshare.akfamily.xyz/data/stock/stock.html#id199 "Link to this heading")

接口: stock\_financial\_hk\_report\_em

目标地址: https://emweb.securities.eastmoney.com/PC\_HKF10/FinancialAnalysis/index?type=web&code=00700
...
|---|---|---|
|SECUCODE|object|\-|
|SECURITY\_CODE|object|\-|
|SECURITY\_NAME\_ABBR|object|\-|
|ORG\_CODE|object|\-|
|REPORT\_DATE|object|\-|
|DATE\_TYPE\_CODE|object|\-|
|FISCAL\_YEAR|object|\-|
|STD\_ITEM\_CODE|object|\-|
|STD\_ITEM\_NAME|object|\-|
|AMOUNT|float64|\-|
|STD\_REPORT\_DATE|object|\-|
...
### 美股财务报表[](https://akshare.akfamily.xyz/data/stock/stock.html#id200 "Link to this heading")

接口: stock\_financial\_us\_report\_em

目标地址: https://emweb.eastmoney.com/PC\_USF10/pages/index.html?code=TSLA&type=web&color=w#/cwfx/zyzb
...
### 关键指标-新浪[](https://akshare.akfamily.xyz/data/stock/stock.html#id201 "Link to this heading")

接口: stock\_financial\_abstract

目标地址: https://vip.stock.finance.sina.com.cn/corp/go.php/vFD\_FinanceSummary/stockid/600004.phtml
...
### 关键指标-同花顺[](https://akshare.akfamily.xyz/data/stock/stock.html#id202 "Link to this heading")

接口: stock\_financial\_abstract\_ths
...
### 主要指标-东方财富[](https://akshare.akfamily.xyz/data/stock/stock.html#id203 "Link to this heading")
...
|SECURITY\_CODE|object|股票代码|
|SECURITY\_NAME\_ABBR|object|股票名称|
|REPORT\_DATE|object|报告日期|
|REPORT\_TYPE|object|报告类型|
|REPORT\_DATE\_NAME|object|报告日期名称|
...
### 财务指标[](https://akshare.akfamily.xyz/data/stock/stock.html#id204 "Link to this heading")

接口: stock\_financial\_analysis\_indicator

目标地址: https://money.finance.sina.com.cn/corp/go.php/vFD\_FinancialGuideLine/stockid/600004/ctrl/2019/displaytype/4.phtml

描述: 新浪财经-财务分析-财务指标

限量: 单次获取指定 symbol 和 start\_year 的所有财务指标历史数据
...
|---|---|---|
|symbol|str|symbol="600004"; 股票代码|
|start\_year|str|start\_year="2020"; 开始查询的时间|
...
### 港股财务指标[](https://akshare.akfamily.xyz/data/stock/stock.html#id205 "Link to this heading")

接口: stock\_financial\_hk\_analysis\_indicator\_em

目标地址: https://emweb.securities.eastmoney.com/PC\_HKF10/NewFinancialAnalysis/index?type=web&code=00700
...
|SECURITY\_CODE|object|股票代码(不带HK后缀)|
|SECURITY\_NAME\_ABBR|object|股票名称|
|ORG\_CODE|object|ORG\_CODE|
|REPORT\_DATE|object|报告日期|
|DATE\_TYPE\_CODE|object|报告日期类型|
|PER\_NETCASH\_OPERATE|float64|每股经营现金流(元)|
|PER\_OI|float64|每股营业收入(元)|
|BPS|float64|每股净资产(元)|
|BASIC\_EPS|float64|基本每股收益(元)|
|DILUTED\_EPS|float64|稀释每股收益(元)|
|OPERATE\_INCOME|int64|营业总收入(元)|
|OPERATE\_INCOME\_YOY|float64|营业总收入同比增长(%)|
|GROSS\_PROFIT|int64|毛利润(元)|
|GROSS\_PROFIT\_YOY|float64|毛利润同比增长(%)|
|HOLDER\_PROFIT|int64|归母净利润(元)|
|HOLDER\_PROFIT\_YOY|float64|归母净利润同比增长(%)|
|GROSS\_PROFIT\_RATIO|float64|毛利率(%)|
|EPS\_TTM|float64|TTM每股收益(元)|
|OPERATE\_INCOME\_QOQ|float64|营业总收入滚动环比增长(%)|
|NET\_PROFIT\_RATIO|float64|净利率(%)|
|ROE\_AVG|float64|平均净资产收益率(%)|
|GROSS\_PROFIT\_QOQ|float64|毛利润滚动环比增长(%)|
|ROA|float64|总资产净利率(%)|
|HOLDER\_PROFIT\_QOQ|float64|归母净利润滚动环比增长(%)|
|ROE\_YEARLY|float64|年化净资产收益率(%)|
|ROIC\_YEARLY|float64|年化投资回报率(%)|
|TAX\_EBT|float64|所得税/利润总额(%)|
|OCF\_SALES|float64|经营现金流/营业收入(%)|
|DEBT\_ASSET\_RATIO|float64|资产负债率(%)|
|CURRENT\_RATIO|float64|流动比率(倍)|
|CURRENTDEBT\_DEBT|float64|流动负债/总负债(%)|
|START\_DATE|object|START\_DATE|
|FISCAL\_YEAR|object|年结日|
|CURRENCY|object|CURRENCY|
|IS\_CNY\_CODE|int64|IS\_CNY\_CODE|
...
### 美股财务指标[](https://akshare.akfamily.xyz/data/stock/stock.html#id206 "Link to this heading")

接口: stock\_financial\_us\_analysis\_indicator\_em
...
|SECURITY\_NAME\_ABBR|object|\-|
|ORG\_CODE|object|\-|
|SECURITY\_INNER\_CODE|object|\-|
|ACCOUNTING\_STANDARDS|object|\-|
|NOTICE\_DATE|object|\-|
|START\_DATE|object|\-|
|REPORT\_DATE|object|\-|
|FINANCIAL\_DATE|object|\-|
|STD\_REPORT\_DATE|object|\-|
|CURRENCY|object|\-|
|DATE\_TYPE|object|\-|
|DATE\_TYPE\_CODE|object|\-|
|REPORT\_TYPE|object|\-|
|REPORT\_DATA\_TYPE|object|\-|
|ORGTYPE|object|\-|
|OPERATE\_INCOME|float64|\-|
|OPERATE\_INCOME\_YOY|float64|\-|
|GROSS\_PROFIT|float64|\-|
|GROSS\_PROFIT\_YOY|float64|\-|
|PARENT\_HOLDER\_NETPROFIT|int64|\-|
|PARENT\_HOLDER\_NETPROFIT\_YOY|float64|\-|
|BASIC\_EPS|float64|\-|
|DILUTED\_EPS|float64|\-|
|GROSS\_PROFIT\_RATIO|float64|\-|
|NET\_PROFIT\_RATIO|float64|\-|
|ACCOUNTS\_RECE\_TR|float64|\-|
|INVENTORY\_TR|float64|\-|
|TOTAL\_ASSETS\_TR|float64|\-|
|ACCOUNTS\_RECE\_TDAYS|float64|\-|
|INVENTORY\_TDAYS|float64|\-|
|TOTAL\_ASSETS\_TDAYS|float64|\-|
|ROE\_AVG|float64|\-|
|ROA|float64|\-|
|CURRENT\_RATIO|float64|\-|
|SPEED\_RATIO|float64|\-|
|OCF\_LIQDEBT|float64|\-|
|DEBT\_ASSET\_RATIO|float64|\-|
|EQUITY\_RATIO|float64|\-|
|BASIC\_EPS\_YOY|float64|\-|
|GROSS\_PROFIT\_RATIO\_YOY|float64|\-|
|NET\_PROFIT\_RATIO\_YOY|float64|\-|
|ROE\_AVG\_YOY|float64|\-|
|ROA\_YOY|float64|\-|
|DEBT\_ASSET\_RATIO\_YOY|float64|\-|
|CURRENT\_RATIO\_YOY|float64|\-|
|SPEED\_RATIO\_YOY|float64|\-|
...
### 历史分红[](https://akshare.akfamily.xyz/data/stock/stock.html#id207 "Link to this heading")

接口: stock\_history\_dividend
...
### 十大流通股东(个股)[](https://akshare.akfamily.xyz/data/stock/stock.html#id208 "Link to this heading")

接口: stock\_gdfx\_free\_top\_10\_em

目标地址: https://emweb.securities.eastmoney.com/PC\_HSF10/ShareholderResearch/Index?type=web&code=SH688686#sdltgd-0
...
### 十大股东(个股)[](https://akshare.akfamily.xyz/data/stock/stock.html#id209 "Link to this heading")

接口: stock\_gdfx\_top\_10\_em
...
### 股东持股变动统计-十大流通股东[](https://akshare.akfamily.xyz/data/stock/stock.html#id210 "Link to this heading")

接口: stock\_gdfx\_free\_holding\_change\_em
...
### 股东持股变动统计-十大股东[](https://akshare.akfamily.xyz/data/stock/stock.html#id211 "Link to this heading")

接口: stock\_gdfx\_holding\_change\_em
...
### 高管持股变动统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id212 "Link to this heading")

接口: stock\_management\_change\_ths
...
### 股东持股变动统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id213 "Link to this heading")

接口: stock\_shareholder\_change\_ths
...
### 股东持股分析-十大流通股东[](https://akshare.akfamily.xyz/data/stock/stock.html#id214 "Link to this heading")

接口: stock\_gdfx\_free\_holding\_analyse\_em
...
### 股东持股分析-十大股东[](https://akshare.akfamily.xyz/data/stock/stock.html#id215 "Link to this heading")

接口: stock\_gdfx\_holding\_analyse\_em
...
### 股东持股明细-十大流通股东[](https://akshare.akfamily.xyz/data/stock/stock.html#id216 "Link to this heading")

接口: stock\_gdfx\_free\_holding\_detail\_em
...
### 股东持股明细-十大股东[](https://akshare.akfamily.xyz/data/stock/stock.html#id217 "Link to this heading")

接口: stock\_gdfx\_holding\_detail\_em
...
### 股东持股统计-十大流通股东[](https://akshare.akfamily.xyz/data/stock/stock.html#id218 "Link to this heading")

接口: stock\_gdfx\_free\_holding\_statistics\_em
...
### 股东持股统计-十大股东[](https://akshare.akfamily.xyz/data/stock/stock.html#id219 "Link to this heading")

接口: stock\_gdfx\_holding\_statistics\_em
...
### 股东协同-十大流通股东[](https://akshare.akfamily.xyz/data/stock/stock.html#id220 "Link to this heading")

接口: stock\_gdfx\_free\_holding\_teamwork\_em
...
### 股东协同-十大股东[](https://akshare.akfamily.xyz/data/stock/stock.html#id221 "Link to this heading")

接口: stock\_gdfx\_holding\_teamwork\_em
...
### 股东户数[](https://akshare.akfamily.xyz/data/stock/stock.html#id222 "Link to this heading")

接口: stock\_zh\_a\_gdhs
...
### 股东户数详情[](https://akshare.akfamily.xyz/data/stock/stock.html#id223 "Link to this heading")

接口: stock\_zh\_a\_gdhs\_detail\_em
...
### 分红配股[](https://akshare.akfamily.xyz/data/stock/stock.html#id224 "Link to this heading")

接口: stock\_history\_dividend\_detail

目标地址: https://vip.stock.finance.sina.com.cn/corp/go.php/vISSUE\_ShareBonus/stockid/300670.phtml
...
### 历史分红[](https://akshare.akfamily.xyz/data/stock/stock.html#id225 "Link to this heading")

接口: stock\_dividend\_cninfo
...
### 新股发行[](https://akshare.akfamily.xyz/data/stock/stock.html#id226 "Link to this heading")

接口: stock\_ipo\_info

目标地址: https://vip.stock.finance.sina.com.cn/corp/go.php/vISSUE\_NewStock/stockid/600004.phtml
...
### 股票增发[](https://akshare.akfamily.xyz/data/stock/stock.html#id227 "Link to this heading")

接口: stock\_add\_stock

目标地址: https://vip.stock.finance.sina.com.cn/corp/go.php/vISSUE\_AddStock/stockid/600004.phtml
...
### 限售解禁[](https://akshare.akfamily.xyz/data/stock/stock.html#id228 "Link to this heading")

#### 个股限售解禁-新浪[](https://akshare.akfamily.xyz/data/stock/stock.html#id229 "Link to this heading")

接口: stock\_restricted\_release\_queue\_sina
...
#### 限售股解禁[](https://akshare.akfamily.xyz/data/stock/stock.html#id230 "Link to this heading")

接口: stock\_restricted\_release\_summary\_em
...
|start\_date|str|start\_date="20221101"|
|end\_date|str|end\_date="20221209"|
...
#### 限售股解禁详情[](https://akshare.akfamily.xyz/data/stock/stock.html#id231 "Link to this heading")

接口: stock\_restricted\_release\_detail\_em
...
|名称|类型|描述|
|---|---|---|
|start\_date|str|start\_date="20221202"|
|end\_date|str|end\_date="20241202"|
...
#### 解禁批次[](https://akshare.akfamily.xyz/data/stock/stock.html#id232 "Link to this heading")

接口: stock\_restricted\_release\_queue\_em
...
#### 解禁股东[](https://akshare.akfamily.xyz/data/stock/stock.html#id233 "Link to this heading")

接口: stock\_restricted\_release\_stockholder\_em
...
|---|---|---|
|symbol|str|symbol="600000"|
|date|str|date="20200904"; 通过 ak.stock\_restricted\_release\_queue\_em(symbol="600000") 获取|
...
### 流通股东[](https://akshare.akfamily.xyz/data/stock/stock.html#id234 "Link to this heading")

接口: stock\_circulate\_stock\_holder

目标地址: https://vip.stock.finance.sina.com.cn/corp/go.php/vCI\_CirculateStockHolder/stockid/600000.phtml
...
### 板块行情[](https://akshare.akfamily.xyz/data/stock/stock.html#id235 "Link to this heading")
...
### 板块详情[](https://akshare.akfamily.xyz/data/stock/stock.html#id236 "Link to this heading")

接口: stock\_sector\_detail

目标地址: http://finance.sina.com.cn/stock/sl/#area\_1
...
|名称|类型|描述|
|---|---|---|
|sector|str|sector="hangye\_ZL01"; 通过 **ak.stock\_sector\_spot** 返回数据的 label 字段选择 sector|
...
### 股票列表-A股[](https://akshare.akfamily.xyz/data/stock/stock.html#id237 "Link to this heading")

接口: stock\_info\_a\_code\_name
...
### 股票列表-上证[](https://akshare.akfamily.xyz/data/stock/stock.html#id238 "Link to this heading")

接口: stock\_info\_sh\_name\_code
...
### 股票列表-深证[](https://akshare.akfamily.xyz/data/stock/stock.html#id239 "Link to this heading")

接口: stock\_info\_sz\_name\_code
...
### 股票列表-北证[](https://akshare.akfamily.xyz/data/stock/stock.html#id240 "Link to this heading")

接口: stock\_info\_bj\_name\_code
...
### 终止/暂停上市-深证[](https://akshare.akfamily.xyz/data/stock/stock.html#id241 "Link to this heading")

接口: stock\_info\_sz\_delist
...
### 两网及退市[](https://akshare.akfamily.xyz/data/stock/stock.html#id242 "Link to this heading")

接口: stock\_staq\_net\_stop

目标地址: https://quote.eastmoney.com/center/gridlist.html#staq\_net\_board
...
### 暂停/终止上市-上证[](https://akshare.akfamily.xyz/data/stock/stock.html#id243 "Link to this heading")

接口: stock\_info\_sh\_delist
...
### 股票更名[](https://akshare.akfamily.xyz/data/stock/stock.html#id244 "Link to this heading")

接口: stock\_info\_change\_name

目标地址: https://vip.stock.finance.sina.com.cn/corp/go.php/vCI\_CorpInfo/stockid/300378.phtml
...
### 名称变更-深证[](https://akshare.akfamily.xyz/data/stock/stock.html#id245 "Link to this heading")

接口: stock\_info\_sz\_change\_name
...
### 基金持股[](https://akshare.akfamily.xyz/data/stock/stock.html#id246 "Link to this heading")

接口: stock\_fund\_stock\_holder

目标地址: https://vip.stock.finance.sina.com.cn/corp/go.php/vCI\_FundStockHolder/stockid/600004.phtml
...
### 主要股东[](https://akshare.akfamily.xyz/data/stock/stock.html#id247 "Link to this heading")

接口: stock\_main\_stock\_holder

目标地址: https://vip.stock.finance.sina.com.cn/corp/go.php/vCI\_StockHolder/stockid/600004.phtml
...
### 机构持股[](https://akshare.akfamily.xyz/data/stock/stock.html#id248 "Link to this heading")

#### 机构持股一览表[](https://akshare.akfamily.xyz/data/stock/stock.html#id249 "Link to this heading")

接口: stock\_institute\_hold
...
#### 机构持股详情[](https://akshare.akfamily.xyz/data/stock/stock.html#id250 "Link to this heading")

接口: stock\_institute\_hold\_detail
...
### 机构推荐[](https://akshare.akfamily.xyz/data/stock/stock.html#id251 "Link to this heading")

#### 机构推荐池[](https://akshare.akfamily.xyz/data/stock/stock.html#id252 "Link to this heading")

接口: stock\_institute\_recommend

目标地址: http://stock.finance.sina.com.cn/stock/go.php/vIR\_RatingNewest/index.phtml
...
#### 股票评级记录[](https://akshare.akfamily.xyz/data/stock/stock.html#id253 "Link to this heading")

接口: stock\_institute\_recommend\_detail

目标地址: http://stock.finance.sina.com.cn/stock/go.php/vIR\_StockSearch/key/sz000001.phtml
...
#### 投资评级[](https://akshare.akfamily.xyz/data/stock/stock.html#id254 "Link to this heading")

接口: stock\_rank\_forecast\_cninfo
...
#### 申万个股行业分类变动历史[](https://akshare.akfamily.xyz/data/stock/stock.html#id255 "Link to this heading")

接口: stock\_industry\_clf\_hist\_sw

目标地址: http://www.swhyresearch.com/institute\_sw/allIndex/downloadCenter/industryType
...
|---|---|---|
|symbol|object|股票代码|
|start\_date|object|计入日期|
|industry\_code|object|申万行业代码|
|update\_time|object|更新日期|
...
#### 行业市盈率[](https://akshare.akfamily.xyz/data/stock/stock.html#id256 "Link to this heading")

接口: stock\_industry\_pe\_ratio\_cninfo
...
#### 新股过会[](https://akshare.akfamily.xyz/data/stock/stock.html#id257 "Link to this heading")

接口: stock\_new\_gh\_cninfo
...
#### 新股发行[](https://akshare.akfamily.xyz/data/stock/stock.html#id258 "Link to this heading")

接口: stock\_new\_ipo\_cninfo
...
#### 董监高及相关人员持股变动-上证[](https://akshare.akfamily.xyz/data/stock/stock.html#id259 "Link to this heading")

接口: stock\_share\_hold\_change\_sse
...
#### 董监高及相关人员持股变动-深证[](https://akshare.akfamily.xyz/data/stock/stock.html#id260 "Link to this heading")

接口: stock\_share\_hold\_change\_szse
...
#### 董监高及相关人员持股变动-北证[](https://akshare.akfamily.xyz/data/stock/stock.html#id261 "Link to this heading")

接口: stock\_share\_hold\_change\_bse

目标地址: https://www.bse.cn/disclosure/djg\_sharehold\_change.html
...
#### 股东人数及持股集中度[](https://akshare.akfamily.xyz/data/stock/stock.html#id262 "Link to this heading")

接口: stock\_hold\_num\_cninfo
...
#### 股本变动[](https://akshare.akfamily.xyz/data/stock/stock.html#id263 "Link to this heading")

接口: stock\_hold\_change\_cninfo
...
#### 实际控制人持股变动[](https://akshare.akfamily.xyz/data/stock/stock.html#id264 "Link to this heading")

接口: stock\_hold\_control\_cninfo
...
#### 高管持股变动明细[](https://akshare.akfamily.xyz/data/stock/stock.html#id265 "Link to this heading")

接口: stock\_hold\_management\_detail\_cninfo
...
#### 董监高及相关人员持股变动明细[](https://akshare.akfamily.xyz/data/stock/stock.html#id266 "Link to this heading")

接口: stock\_hold\_management\_detail\_em
...
#### 人员增减持股变动明细[](https://akshare.akfamily.xyz/data/stock/stock.html#id267 "Link to this heading")

接口: stock\_hold\_management\_person\_em
...
#### 对外担保[](https://akshare.akfamily.xyz/data/stock/stock.html#id268 "Link to this heading")

接口: stock\_cg\_guarantee\_cninfo
...
|start\_date|str|start\_date="20180630"|
|end\_date|str|end\_date="20210927"|
...
#### 公司诉讼[](https://akshare.akfamily.xyz/data/stock/stock.html#id269 "Link to this heading")

接口: stock\_cg\_lawsuit\_cninfo
...
#### 股权质押[](https://akshare.akfamily.xyz/data/stock/stock.html#id270 "Link to this heading")

接口: stock\_cg\_equity\_mortgage\_cninfo
...
### 美港目标价[](https://akshare.akfamily.xyz/data/stock/stock.html#id271 "Link to this heading")
...
### 券商业绩月报[](https://akshare.akfamily.xyz/data/stock/stock.html#id272 "Link to this heading")
...
### A 股股息率[](https://akshare.akfamily.xyz/data/stock/stock.html#id273 "Link to this heading")

接口: stock\_a\_gxl\_lg
...
### 恒生指数股息率[](https://akshare.akfamily.xyz/data/stock/stock.html#id274 "Link to this heading")

接口: stock\_hk\_gxl\_lg
...
### 大盘拥挤度[](https://akshare.akfamily.xyz/data/stock/stock.html#id275 "Link to this heading")

接口: stock\_a\_congestion\_lg
...
### 股债利差[](https://akshare.akfamily.xyz/data/stock/stock.html#id276 "Link to this heading")
...
### 巴菲特指标[](https://akshare.akfamily.xyz/data/stock/stock.html#id277 "Link to this heading")

接口: stock\_buffett\_index\_lg
...
### A 股等权重与中位数市盈率[](https://akshare.akfamily.xyz/data/stock/stock.html#id278 "Link to this heading")

接口: stock\_a\_ttm\_lyr
...
### A 股等权重与中位数市净率[](https://akshare.akfamily.xyz/data/stock/stock.html#id279 "Link to this heading")

接口: stock\_a\_all\_pb
...
### 主板市盈率[](https://akshare.akfamily.xyz/data/stock/stock.html#id280 "Link to this heading")

接口: stock\_market\_pe\_lg
...
### 指数市盈率[](https://akshare.akfamily.xyz/data/stock/stock.html#id281 "Link to this heading")

接口: stock\_index\_pe\_lg
...
### 主板市净率[](https://akshare.akfamily.xyz/data/stock/stock.html#id282 "Link to this heading")

接口: stock\_market\_pb\_lg
...
### 指数市净率[](https://akshare.akfamily.xyz/data/stock/stock.html#id283 "Link to this heading")

接口: stock\_index\_pb\_lg
...
### A 股估值指标[](https://akshare.akfamily.xyz/data/stock/stock.html#id284 "Link to this heading")

接口: stock\_zh\_valuation\_baidu
...
### 个股估值[](https://akshare.akfamily.xyz/data/stock/stock.html#id285 "Link to this heading")
...
### 涨跌投票[](https://akshare.akfamily.xyz/data/stock/stock.html#id286 "Link to this heading")

接口: stock\_zh\_vote\_baidu
...
### 港股个股指标[](https://akshare.akfamily.xyz/data/stock/stock.html#id287 "Link to this heading")

P.S. 该数据源暂未更新数据

接口: stock\_hk\_indicator\_eniu
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="hk01093"; 可通过调用 **ak.stock\_hk\_indicator\_eniu(symbol="hk01093", indicator="港股")** 获取股票代码|
...
### 港股估值指标[](https://akshare.akfamily.xyz/data/stock/stock.html#id288 "Link to this heading")

接口: stock\_hk\_valuation\_baidu
...
### 创新高和新低的股票数量[](https://akshare.akfamily.xyz/data/stock/stock.html#id289 "Link to this heading")

接口: stock\_a\_high\_low\_statistics
...
### 破净股统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id290 "Link to this heading")

接口: stock\_a\_below\_net\_asset\_statistics
...
|---|---|---|
|date|object|交易日|
|below\_net\_asset|float64|破净股家数|
|total\_company|float64|总公司数|
|below\_net\_asset\_ratio|float64|破净股比率|
...
### 基金持股[](https://akshare.akfamily.xyz/data/stock/stock.html#id291 "Link to this heading")

接口: stock\_report\_fund\_hold
...
### 基金持股明细[](https://akshare.akfamily.xyz/data/stock/stock.html#id292 "Link to this heading")

接口: stock\_report\_fund\_hold\_detail
...
### 龙虎榜[](https://akshare.akfamily.xyz/data/stock/stock.html#id293 "Link to this heading")

#### 龙虎榜-东财[](https://akshare.akfamily.xyz/data/stock/stock.html#id294 "Link to this heading")

##### 龙虎榜详情[](https://akshare.akfamily.xyz/data/stock/stock.html#id295 "Link to this heading")

接口: stock\_lhb\_detail\_em
...
|名称|类型|描述|
|---|---|---|
|start\_date|str|start\_date="20220314"|
|end\_date|str|end\_date="20220315"|
...
##### 个股上榜统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id296 "Link to this heading")

接口: stock\_lhb\_stock\_statistic\_em
...
##### 机构买卖每日统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id297 "Link to this heading")

接口: stock\_lhb\_jgmmtj\_em
...
|名称|类型|描述|
|---|---|---|
|start\_date|str|start\_date="20240417"|
|end\_date|str|end\_date="20240430"|
...
##### 机构席位追踪[](https://akshare.akfamily.xyz/data/stock/stock.html#id298 "Link to this heading")

接口: stock\_lhb\_jgstatistic\_em
...
##### 每日活跃营业部[](https://akshare.akfamily.xyz/data/stock/stock.html#id299 "Link to this heading")

接口: stock\_lhb\_hyyyb\_em
...
|名称|类型|描述|
|---|---|---|
|start\_date|str|start\_date="20220311"|
|end\_date|str|end\_date="20220315"|
...
### 营业部详情数据-东财[](https://akshare.akfamily.xyz/data/stock/stock.html#id300 "Link to this heading")

接口: stock\_lhb\_yyb\_detail\_em
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="10026729"; 营业部代码, 通过 ak.stock\_lhb\_hyyyb\_em() 接口获取|
...
#### 营业部排行[](https://akshare.akfamily.xyz/data/stock/stock.html#id301 "Link to this heading")

接口: stock\_lhb\_yybph\_em
...
#### 营业部统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id302 "Link to this heading")

接口: stock\_lhb\_traderstatistic\_em
...
#### 个股龙虎榜详情[](https://akshare.akfamily.xyz/data/stock/stock.html#id303 "Link to this heading")

接口: stock\_lhb\_stock\_detail\_em
...
|date|str|date="20220310"; 需要通过 ak.stock\_lhb\_stock\_detail\_date\_em(symbol="600077") 接口获取相应股票的有龙虎榜详情数据的日期|
...
#### 龙虎榜-营业部排行[](https://akshare.akfamily.xyz/data/stock/stock.html#id304 "Link to this heading")

##### 龙虎榜-营业部排行-上榜次数最多[](https://akshare.akfamily.xyz/data/stock/stock.html#id305 "Link to this heading")

接口: stock\_lh\_yyb\_most
...
##### 龙虎榜-营业部排行-资金实力最强[](https://akshare.akfamily.xyz/data/stock/stock.html#id306 "Link to this heading")

接口: stock\_lh\_yyb\_capital
...
##### 龙虎榜-营业部排行-抱团操作实力[](https://akshare.akfamily.xyz/data/stock/stock.html#id307 "Link to this heading")

接口: stock\_lh\_yyb\_control
...
#### 龙虎榜-每日详情[](https://akshare.akfamily.xyz/data/stock/stock.html#id308 "Link to this heading")

接口: stock\_lhb\_detail\_daily\_sina
...
#### 龙虎榜-个股上榜统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id309 "Link to this heading")

接口: stock\_lhb\_ggtj\_sina
...
#### 龙虎榜-营业上榜统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id310 "Link to this heading")

接口: stock\_lhb\_yytj\_sina
...
#### 龙虎榜-机构席位追踪[](https://akshare.akfamily.xyz/data/stock/stock.html#id311 "Link to this heading")

接口: stock\_lhb\_jgzz\_sina
...
#### 龙虎榜-机构席位成交明细[](https://akshare.akfamily.xyz/data/stock/stock.html#id312 "Link to this heading")

接口: stock\_lhb\_jgmx\_sina
...
### 首发申报信息[](https://akshare.akfamily.xyz/data/stock/stock.html#id313 "Link to this heading")

接口: stock\_ipo\_declare
...
### IPO审核信息[](https://akshare.akfamily.xyz/data/stock/stock.html#id314 "Link to this heading")

#### 全部[](https://akshare.akfamily.xyz/data/stock/stock.html#id315 "Link to this heading")

##### 科创板[](https://akshare.akfamily.xyz/data/stock/stock.html#id316 "Link to this heading")

接口: stock\_register\_kcb
...
##### 创业板[](https://akshare.akfamily.xyz/data/stock/stock.html#id317 "Link to this heading")

接口: stock\_register\_cyb
...
##### 上海主板[](https://akshare.akfamily.xyz/data/stock/stock.html#id318 "Link to this heading")

接口: stock\_register\_sh
...
##### 深圳主板[](https://akshare.akfamily.xyz/data/stock/stock.html#id319 "Link to this heading")

接口: stock\_register\_sz
...
##### 北交所[](https://akshare.akfamily.xyz/data/stock/stock.html#id320 "Link to this heading")

接口: stock\_register\_bj
...
#### 达标企业[](https://akshare.akfamily.xyz/data/stock/stock.html#id321 "Link to this heading")

接口: stock\_register\_db
...
### 增发[](https://akshare.akfamily.xyz/data/stock/stock.html#id322 "Link to this heading")
...
### 配股[](https://akshare.akfamily.xyz/data/stock/stock.html#id323 "Link to this heading")
...
### 股票回购数据[](https://akshare.akfamily.xyz/data/stock/stock.html#id324 "Link to this heading")

接口: stock\_repurchase\_em
...
### 股本结构[](https://akshare.akfamily.xyz/data/stock/stock.html#id325 "Link to this heading")

接口: stock\_zh\_a\_gbjg\_em

目标地址: https://emweb.securities.eastmoney.com/pc\_hsf10/pages/index.html#/gbjg
...
## 大宗交易[](https://akshare.akfamily.xyz/data/stock/stock.html#id326 "Link to this heading")

### 市场统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id327 "Link to this heading")

接口: stock\_dzjy\_sctj

目标地址: https://data.eastmoney.com/dzjy/dzjy\_sctj.html
...
### 每日明细[](https://akshare.akfamily.xyz/data/stock/stock.html#id328 "Link to this heading")

接口: stock\_dzjy\_mrmx

目标地址: https://data.eastmoney.com/dzjy/dzjy\_mrmx.html
...
|start\_date|str|start\_date='20201123'; 开始日期|
|end\_date|sr|end\_date='20201204'; 结束日期|
...
### 每日统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id329 "Link to this heading")

接口: stock\_dzjy\_mrtj

目标地址: https://data.eastmoney.com/dzjy/dzjy\_mrtj.html
...
|名称|类型|描述|
|---|---|---|
|start\_date|str|start\_date='20220105'; 开始日期|
|end\_date|sr|end\_date='20220105'; 结束日期|
...
### 活跃 A 股统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id330 "Link to this heading")

接口: stock\_dzjy\_hygtj

目标地址: https://data.eastmoney.com/dzjy/dzjy\_hygtj.html
...
### 活跃营业部统计[](https://akshare.akfamily.xyz/data/stock/stock.html#id331 "Link to this heading")

接口: stock\_dzjy\_hyyybtj

目标地址: https://data.eastmoney.com/dzjy/dzjy\_hyyybtj.html
...
### 营业部排行[](https://akshare.akfamily.xyz/data/stock/stock.html#id332 "Link to this heading")

接口: stock\_dzjy\_yybph

目标地址: https://data.eastmoney.com/dzjy/dzjy\_yybph.html
...
## 一致行动人[](https://akshare.akfamily.xyz/data/stock/stock.html#id333 "Link to this heading")
...
## 融资融券[](https://akshare.akfamily.xyz/data/stock/stock.html#id334 "Link to this heading")

### 标的证券名单及保证金比例查询[](https://akshare.akfamily.xyz/data/stock/stock.html#id335 "Link to this heading")

接口: stock\_margin\_ratio\_pa
...
### 两融账户信息[](https://akshare.akfamily.xyz/data/stock/stock.html#id336 "Link to this heading")

接口: stock\_margin\_account\_info
...
### 上海证券交易所[](https://akshare.akfamily.xyz/data/stock/stock.html#id337 "Link to this heading")

#### 融资融券汇总[](https://akshare.akfamily.xyz/data/stock/stock.html#id338 "Link to this heading")

接口: stock\_margin\_sse
...
|名称|类型|描述|
|---|---|---|
|start\_date|str|start\_date="20010106"|
|end\_date|str|end\_date="20010106"|
...
#### 融资融券明细[](https://akshare.akfamily.xyz/data/stock/stock.html#id339 "Link to this heading")

接口: stock\_margin\_detail\_sse
...
### 深圳证券交易所[](https://akshare.akfamily.xyz/data/stock/stock.html#id340 "Link to this heading")

#### 融资融券汇总[](https://akshare.akfamily.xyz/data/stock/stock.html#id341 "Link to this heading")

接口: stock\_margin\_szse
...
#### 融资融券明细[](https://akshare.akfamily.xyz/data/stock/stock.html#id342 "Link to this heading")

接口: stock\_margin\_detail\_szse
...
#### 标的证券信息[](https://akshare.akfamily.xyz/data/stock/stock.html#id343 "Link to this heading")

接口: stock\_margin\_underlying\_info\_szse
...
## 盈利预测-东方财富[](https://akshare.akfamily.xyz/data/stock/stock.html#id344 "Link to this heading")

接口: stock\_profit\_forecast\_em
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="", 默认为获取全部数据; symbol="船舶制造", 则获取具体行业板块的数据; 行业板块可以通过 ak.stock\_board\_industry\_name\_em() 接口获取|
...
## 港股盈利预测-经济通[](https://akshare.akfamily.xyz/data/stock/stock.html#id345 "Link to this heading")

接口: stock\_hk\_profit\_forecast\_et

目标地址: https://www.etnet.com.hk/www/sc/stocks/realtime/quote\_profit.php?code=9999
...
## 盈利预测-同花顺[](https://akshare.akfamily.xyz/data/stock/stock.html#id346 "Link to this heading")

接口: stock\_profit\_forecast\_ths
...
## 概念板块[](https://akshare.akfamily.xyz/data/stock/stock.html#id347 "Link to this heading")

### 同花顺-概念板块指数[](https://akshare.akfamily.xyz/data/stock/stock.html#id348 "Link to this heading")

接口: stock\_board\_concept\_index\_ths
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="阿里巴巴概念"; 可以通过调用 **ak.stock\_board\_concept\_name\_ths()** 查看同花顺的所有概念名称|
|start\_date|str|start\_date="20200101"; 开始时间|
|end\_date|str|end\_date="20250228"; 结束时间|
...
### 同花顺-概念板块简介[](https://akshare.akfamily.xyz/data/stock/stock.html#id349 "Link to this heading")

接口: stock\_board\_concept\_info\_ths
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol: str = "阿里巴巴概念"; 可以通过调用 **ak.stock\_board\_concept\_name\_ths()** 查看同花顺的所有概念名称|
...
### 东方财富-概念板块[](https://akshare.akfamily.xyz/data/stock/stock.html#id350 "Link to this heading")

接口: stock\_board\_concept\_name\_em

目标地址: https://quote.eastmoney.com/center/boardlist.html#concept\_board
...
### 东方财富-概念板块-实时行情[](https://akshare.akfamily.xyz/data/stock/stock.html#id351 "Link to this heading")

接口: stock\_board\_concept\_spot\_em
...
### 东方财富-成份股[](https://akshare.akfamily.xyz/data/stock/stock.html#id352 "Link to this heading")

接口: stock\_board\_concept\_cons\_em
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="融资融券"; 支持传入板块代码比如：BK0655，可以通过调用 **ak.stock\_board\_concept\_name\_em()** 查看东方财富-概念板块的所有行业名称|
...
### 东方财富-指数[](https://akshare.akfamily.xyz/data/stock/stock.html#id353 "Link to this heading")

接口: stock\_board\_concept\_hist\_em
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="绿色电力"; 可以通过调用 **ak.stock\_board\_concept\_name\_em()** 查看东方财富-概念板块的所有概念代码|
|period|str|period="daily"; choice of {"daily", "weekly", "monthly"}|
|start\_date|str|start\_date="20220101"|
|end\_date|str|end\_date="20221128"|
...
### 东方财富-指数-分时[](https://akshare.akfamily.xyz/data/stock/stock.html#id354 "Link to this heading")

接口: stock\_board\_concept\_hist\_min\_em
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="长寿药"; 可以通过调用 **ak.stock\_board\_concept\_name\_em()** 查看东方财富-概念板块的所有概念代码|
...
### 富途牛牛-美股概念-成分股[](https://akshare.akfamily.xyz/data/stock/stock.html#id355 "Link to this heading")

接口: stock\_concept\_cons\_futu
...
## 行业板块[](https://akshare.akfamily.xyz/data/stock/stock.html#id356 "Link to this heading")

### 同花顺-同花顺行业一览表[](https://akshare.akfamily.xyz/data/stock/stock.html#id357 "Link to this heading")

接口: stock\_board\_industry\_summary\_ths
...
### 同花顺-指数[](https://akshare.akfamily.xyz/data/stock/stock.html#id358 "Link to this heading")

接口: stock\_board\_industry\_index\_ths
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="元件"; 可以通过调用 **ak.stock\_board\_industry\_name\_ths()** 查看同花顺的所有行业名称|
|start\_date|str|start\_date="20200101"; 开始时间|
|end\_date|str|end\_date="20211027"; 结束时间|
...
### 东方财富-行业板块[](https://akshare.akfamily.xyz/data/stock/stock.html#id359 "Link to this heading")

接口: stock\_board\_industry\_name\_em

目标地址: https://quote.eastmoney.com/center/boardlist.html#industry\_board
...
### 东方财富-行业板块-实时行情[](https://akshare.akfamily.xyz/data/stock/stock.html#id360 "Link to this heading")

接口: stock\_board\_industry\_spot\_em
...
### 东方财富-成份股[](https://akshare.akfamily.xyz/data/stock/stock.html#id361 "Link to this heading")

接口: stock\_board\_industry\_cons\_em
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="小金属"; 支持传入板块代码比如：BK1027，可以通过调用 **ak.stock\_board\_industry\_name\_em()** 查看东方财富-行业板块的所有行业代码|
...
### 东方财富-指数-日频[](https://akshare.akfamily.xyz/data/stock/stock.html#id362 "Link to this heading")

接口: stock\_board\_industry\_hist\_em
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="小金属"; 可以通过调用 **ak.stock\_board\_industry\_name\_em()** 查看东方财富-行业板块的所有行业代码|
|start\_date|str|start\_date="20211201";|
|end\_date|str|end\_date="20220401";|
...
### 东方财富-指数-分时[](https://akshare.akfamily.xyz/data/stock/stock.html#id363 "Link to this heading")

接口: stock\_board\_industry\_hist\_min\_em
...
## 股票热度[](https://akshare.akfamily.xyz/data/stock/stock.html#id364 "Link to this heading")

### 股票热度-雪球[](https://akshare.akfamily.xyz/data/stock/stock.html#id365 "Link to this heading")

#### 关注排行榜[](https://akshare.akfamily.xyz/data/stock/stock.html#id366 "Link to this heading")

接口: stock\_hot\_follow\_xq
...
#### 讨论排行榜[](https://akshare.akfamily.xyz/data/stock/stock.html#id367 "Link to this heading")

接口: stock\_hot\_tweet\_xq
...
#### 交易排行榜[](https://akshare.akfamily.xyz/data/stock/stock.html#id368 "Link to this heading")

接口: stock\_hot\_deal\_xq
...
### 股票热度-东财[](https://akshare.akfamily.xyz/data/stock/stock.html#id369 "Link to this heading")

#### 人气榜-A股[](https://akshare.akfamily.xyz/data/stock/stock.html#id370 "Link to this heading")

接口: stock\_hot\_rank\_em
...
#### 飙升榜-A股[](https://akshare.akfamily.xyz/data/stock/stock.html#id371 "Link to this heading")

接口: stock\_hot\_up\_em
...
#### 人气榜-港股[](https://akshare.akfamily.xyz/data/stock/stock.html#id372 "Link to this heading")

接口: stock\_hk\_hot\_rank\_em
...
### 历史趋势及粉丝特征[](https://akshare.akfamily.xyz/data/stock/stock.html#id373 "Link to this heading")

#### A股[](https://akshare.akfamily.xyz/data/stock/stock.html#id374 "Link to this heading")

接口: stock\_hot\_rank\_detail\_em
...
#### 港股[](https://akshare.akfamily.xyz/data/stock/stock.html#id375 "Link to this heading")

接口: stock\_hk\_hot\_rank\_detail\_em

目标地址: https://guba.eastmoney.com/rank/stock?code=HK\_00700
...
### 互动平台[](https://akshare.akfamily.xyz/data/stock/stock.html#id376 "Link to this heading")

#### 互动易-提问[](https://akshare.akfamily.xyz/data/stock/stock.html#id377 "Link to this heading")

接口: stock\_irm\_cninfo
...
#### 互动易-回答[](https://akshare.akfamily.xyz/data/stock/stock.html#id378 "Link to this heading")

接口: stock\_irm\_ans\_cninfo
...
|名称|类型|描述|
|---|---|---|
|symbol|str|symbol="1495108801386602496"; 通过 ak.stock\_irm\_cninfo 来获取具体的提问者编号|
...
### 个股人气榜-实时变动[](https://akshare.akfamily.xyz/data/stock/stock.html#id379 "Link to this heading")

#### A股[](https://akshare.akfamily.xyz/data/stock/stock.html#id380 "Link to this heading")

接口: stock\_hot\_rank\_detail\_realtime\_em
...
#### 港股[](https://akshare.akfamily.xyz/data/stock/stock.html#id381 "Link to this heading")

接口: stock\_hk\_hot\_rank\_detail\_realtime\_em
...
### 热门关键词[](https://akshare.akfamily.xyz/data/stock/stock.html#id382 "Link to this heading")

接口: stock\_hot\_keyword\_em
...
### 内部交易[](https://akshare.akfamily.xyz/data/stock/stock.html#id383 "Link to this heading")

接口: stock\_inner\_trade\_xq
...
### 个股人气榜-最新排名[](https://akshare.akfamily.xyz/data/stock/stock.html#id384 "Link to this heading")

#### A股[](https://akshare.akfamily.xyz/data/stock/stock.html#id385 "Link to this heading")

接口: stock\_hot\_rank\_latest\_em
...
#### 港股[](https://akshare.akfamily.xyz/data/stock/stock.html#id386 "Link to this heading")

接口: stock\_hk\_hot\_rank\_latest\_em
...
### 热搜股票[](https://akshare.akfamily.xyz/data/stock/stock.html#id387 "Link to this heading")

接口: stock\_hot\_search\_baidu
...
### 相关股票[](https://akshare.akfamily.xyz/data/stock/stock.html#id388 "Link to this heading")

接口: stock\_hot\_rank\_relate\_em
...
## 盘口异动[](https://akshare.akfamily.xyz/data/stock/stock.html#id389 "Link to this heading")

接口: stock\_changes\_em
...
## 板块异动详情[](https://akshare.akfamily.xyz/data/stock/stock.html#id390 "Link to this heading")

接口: stock\_board\_change\_em
...
## 涨停板行情[](https://akshare.akfamily.xyz/data/stock/stock.html#id391 "Link to this heading")

### 涨停股池[](https://akshare.akfamily.xyz/data/stock/stock.html#id392 "Link to this heading")

接口: stock\_zt\_pool\_em
...
### 昨日涨停股池[](https://akshare.akfamily.xyz/data/stock/stock.html#id393 "Link to this heading")

接口: stock\_zt\_pool\_previous\_em
...
### 强势股池[](https://akshare.akfamily.xyz/data/stock/stock.html#id394 "Link to this heading")

接口: stock\_zt\_pool\_strong\_em
...
### 次新股池[](https://akshare.akfamily.xyz/data/stock/stock.html#id395 "Link to this heading")

接口: stock\_zt\_pool\_sub\_new\_em
...
### 炸板股池[](https://akshare.akfamily.xyz/data/stock/stock.html#id396 "Link to this heading")

接口: stock\_zt\_pool\_zbgc\_em
...
### 跌停股池[](https://akshare.akfamily.xyz/data/stock/stock.html#id397 "Link to this heading")

接口: stock\_zt\_pool\_dtgc\_em
...
## 赚钱效应分析[](https://akshare.akfamily.xyz/data/stock/stock.html#id398 "Link to this heading")

接口: stock\_market\_activity\_legu
...
## 资讯数据[](https://akshare.akfamily.xyz/data/stock/stock.html#id399 "Link to this heading")

### 财经早餐-东财财富[](https://akshare.akfamily.xyz/data/stock/stock.html#id400 "Link to this heading")

接口：stock\_info\_cjzc\_em
...
### 全球财经快讯-东财财富[](https://akshare.akfamily.xyz/data/stock/stock.html#id401 "Link to this heading")

接口：stock\_info\_global\_em

目标地址：https://kuaixun.eastmoney.com/7\_24.html
...
### 全球财经快讯-新浪财经[](https://akshare.akfamily.xyz/data/stock/stock.html#id402 "Link to this heading")

接口：stock\_info\_global\_sina
...
### 快讯-富途牛牛[](https://akshare.akfamily.xyz/data/stock/stock.html#id403 "Link to this heading")

接口：stock\_info\_global\_futu
...
### 全球财经直播-同花顺财经[](https://akshare.akfamily.xyz/data/stock/stock.html#id404 "Link to this heading")

接口：stock\_info\_global\_ths
...
### 电报-财联社[](https://akshare.akfamily.xyz/data/stock/stock.html#id405 "Link to this heading")

接口：stock\_info\_global\_cls
